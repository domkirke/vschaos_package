...
class ActNormNd(nn.Module):
    def __init__(self, num_features, ndim=1, eps=1e-12):
...
class ActNorm1d(ActNormNd):
    ...
    def __init__(self, *args, **kwargs):
        kwargs['ndim'] = 1
        super(ActNorm1d, self).__init__(*args, **kwargs)
...
class ActNorm2d(ActNormNd):
    def __init__(self, *args, **kwargs):
        kwargs['ndim'] = 2
        super(ActNorm2d, self).__init__(*args, **kwargs)
    @property
    def shape(self):
                return [1, -1, 1, 1]
...
class ActNorm3d(ActNormNd):
    def __init__(self, *args, **kwargs):
        kwargs['ndim'] = 3
        super(ActNorm3d, self).__init__(*args, **kwargs)
    @property
    def shape(self):
        return [1, -1, 1, 1, 1]
